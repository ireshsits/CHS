...
class ComplaintCompletion extends Model
{
    use SoftDeletes;
    
//     protected $connection = 'oracle';
    protected $table = "complaint_completions";
    protected $primaryKey = 'complaint_completion_id_pk';
    ...
    public static function updateStatus($id, $data, $mode='ALL') {
        ...
        switch($mode){
            ...
            case 'ONE': parent::where('complaint_completion_id_pk',$id)->update(['status' => $data['status']]);break;
            default	  : null;break;
        }
    }
