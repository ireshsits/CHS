...
@section('page-title', 'Complaint Handling System | 401') 

@section('meta-description') 
     Complaint Handling System | 401 
@endsection 
		...
		<div class="row align-items-center justify-content-center">
			...
			<div class="col-lg-6">
				<div class="fxt-content">
					<h1 class="error-page-title">401</h1>
					<h5 class="error-page-msg">Oops, an error has occurred. Unauthorized!</h5>
