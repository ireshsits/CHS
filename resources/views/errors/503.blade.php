...
@section('page-title', 'Complaint Handling System | 503') 

@section('meta-description') 
     Complaint Handling System | 503
@endsection 
		...
		<div class="row align-items-center justify-content-center">
			...
			<div class="col-lg-6">
				<div class="fxt-content">
					<h1 class="error-page-title">503</h1>
					<h5 class="error-page-msg">Oops, an error has occurred. Service unavailable!</h5>
