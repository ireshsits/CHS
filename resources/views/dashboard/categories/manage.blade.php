...
@section('page-title', 'Complaint Handling System | Category Manage')

@section('meta-description')
    Complaint Handling System | Category Manage
@endsection
...
<div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i> Manage Categories </h2>
...
<!--                       </li> -->
                  ...
                  <div class="x_content">
                    ...
                    <button type="button" id="active-category" class="btn btn-success btn-sm" onclick="updateStatus('dashboard/categories',0,false,'status','ACT')">Active All</button>
                    <button type="button" id="inactive-category" class="btn btn-warning btn-sm" onclick="updateStatus('dashboard/categories',0,false,'status','INACT')">Inactive All</button>
                    @endhasanyrole
                    <button type="button" class="btn btn-default btn-sm" onclick="actionNew('dashboard/categories',true)">Setup +</button>
                    </div>
                    
                      <table class="table table-striped categories-table jambo_table">
                        <thead>
                          <tr class="headings">
                            <th class="column-title" style="width: 3%"></th>
                            <th class="column-title" style="width: 35%">Name</th>
                            <th class="column-title" style="width: 5%">Level</th>
                            <th class="column-title" style="width: 20%">Parent Category</th>
...
@section('page-js')
	...
	<script type="text/javascript" src="{{ mix('dashboard/compiled/js/categories/manage.min.js') }}"></script>
@endsection

@section('modal-js')
	<script type="text/javascript" src="{{ mix('dashboard/compiled/js/categories/setup.min.js') }}"></script>
@endsection