...
<!-- 							<span class="header-tag"> "We Present Your Future"<span></span></span></td> -->
                      </tr>
                    </table>
                  </div>
                </td>
            ...
            <table class="inner-table">
              <tr>
                <td class="inner-table-td">
                    ...
                    <p class="subject-para"><br/>You have recieved a Customer Complaint Event Reporting (CCER),</p>
                    <p class="subject-para"><br/>Ref No:{{$data->reference_number}}, from {{$data->complaint_recipient}}.</p>
                    <p class="subject-para"><br/>Please access the {{config('app.name')}} through below link.</p>
