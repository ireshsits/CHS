            ...
            <table class="inner-table">
              <tr>
                <td class="inner-table-td">
                    ...
                    <p class="subject-para"><br/>Above captioned CCER is pending for completion.</p>
<!--                     <p class="subject-para"><br />This has been escalated to .......... (email ID of escalated authority).</p> -->
