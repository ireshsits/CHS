            ...
            <table class="inner-table">
              <tr>
                <td class="inner-table-td">
                    ...
                    <p class="subject-para"><br/>Reference Nnumber : {{$data->reference_number}},</p>
                    <p class="subject-para"><br/>Above captioned CCER has been re-opened by {{$data->complaint_reopened_by}}</p>
