...
@section('page-title', 'Complaint Handling System | Sub Category Manage')

@section('meta-description')
    Complaint Handling System | Sub Category Manage
@endsection
...
<div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i> Manage Sub Categories </h2>
...
<!--                       </li> -->
                  ...
                  <div class="table-responsive">
                    ...
                    <button type="button" id="active-sub_category" class="btn btn-success btn-sm" onclick="updateStatus('dashboard/sub_categories',0,false,'status','ACT')"  >Active All</button>
                    <button type="button" id="inactive-sub_category" class="btn btn-warning btn-sm" onclick="updateStatus('dashboard/sub_categories',0,false,'status','INACT')">Inactive All</button>
                    @endhasanyrole
                    <button type="button" class="btn btn-default btn-sm" onclick="actionNew('dashboard/sub_categories',true)">Setup +</button>
                    </div>
                    
                      <table class="table table-striped sub-categories-table jambo_table">
                        <thead>
                          <tr class="headings">
                            <th class="column-title" style="width: 18%">Sub Category Name</th>
                            <th class="column-title" style="width: 20%">Category Name </th>
                            <th class="column-title" style="width: 20%">Area </th>
                            <th class="column-title" style="width: 10%">Color</th>
...
@section('page-js')
	...
	<script type="text/javascript" src="{{ mix('dashboard/compiled/js/sub_categories/manage.min.js') }}"></script>
@endsection
@section('modal-js')
	<script type="text/javascript" src="{{ mix('dashboard/compiled/js/sub_categories/setup.min.js') }}"></script>
@endsection