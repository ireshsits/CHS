...
<div class="right_col" role="main">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i> Manage Regions </h2>
...
<!--                       </li> -->
                  ...
                  <div class="table-responsive">
                    ...
                    <button type="button" id="active-region" class="btn btn-success btn-sm" onclick="updateStatus('dashboard/regions',0,false,'status','ACT')"  >Active All</button>
                    <button type="button" id="inactive-region" class="btn btn-warning btn-sm" onclick="updateStatus('dashboard/regions',0,false,'status','INACT')">Inactive All</button>
                    @endhasanyrole
                    <button type="button" class="btn btn-default btn-sm" onclick="actionNew('dashboard/regions',false)">Setup +</button>
                    </div>
