...
/***/ "./public/dashboard/js/search/manage.js":
/*!**********************************************!*\
  !*** ./public/dashboard/js/search/manage.js ***!
  \**********************************************/
...
$(function () {
  ...
  var tablesClasses = [//                            '.'+type+'-table-pending', 
  //                            '.'+type+'-table-forward',
  ...
  $.each(tablesClasses, function (index, tclass) {
    var element = $(tclass);
    if (typeof element != 'undefined' && element != null) init_search_tables(tclass);
  }); //    initComplaintRefNumber();
  //    initComplaintCustomerNIC();
  //    initComplaintAccountNo();

  initPageSelectors();
  eventHandler(); //    initSearchValidation();
}); // select boxes
...
window.editByFlow = function (flow, id, modal, subMode, sid) {
  ...
  console.log('Redirect to URL >> ' + URL); //    window.location = URL;
...
function initSearchValidation() {
  ...
  $("#complaint-search-form").validate({
    ...
    highlight: function highlight(label) {
      $(label).closest('.form-group').removeClass('has-success').addClass('has-error'); //            if($(label).is('select')){
      //                $(label).parent().find('.select2-container .selection .select2-selection').removeClass('has-success').addClass('has-select-error');
      //            }
    },
    success: function success(label) {
      $(label).closest('.form-group').removeClass('has-error'); //            if($(label).is('select')){
...
$("#btn-search").on("click", function () {
  ...
  $.each(tablesClasses, function (index, tclass) {
    var element = $(tclass);
    if (typeof element != 'undefined' && element != null) $(element).DataTable().ajax.reload();
  });
});
/**
  ...
  var handleDataTableButtons = function handleDataTableButtons() {
    ...
    table = $(element).DataTable({
      ...
      ajax: {
        ...
        data: function data(d) {
          if (element == '.' + type + '-table-search') {
            d.table = 'SEARCH', d.status = '', d.type = typeCode, d.search = search, d.ref_no = ref_no, d.nic = nic, d.account_no = account_no, d.contact_no = contact_no;
          }
        }
      },
      columns: [{
      ...
      createdRow: function createdRow(nRow, aData, iDataIndex) {
        $(nRow).addClass(aData.priority_level_text); //                var fileRow = '';
...
/***/ 13:
/*!****************************************************!*\
  !*** multi ./public/dashboard/js/search/manage.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\wamp64\www\sits\complaintms_NSC_V1\public\dashboard\js\search\manage.js */"./public/dashboard/js/search/manage.js");
