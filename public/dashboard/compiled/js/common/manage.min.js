...
/***/ "./public/dashboard/js/common/manage.js":
/*!**********************************************!*\
  !*** ./public/dashboard/js/common/manage.js ***!
  \**********************************************/
/*! no static exports found */
...
window.actionStatus = function (status) {
  switch (status) {
    ...
    case 'ESC':
      return '<span class="label label-info">Escalated</span>';
      break;
    //	case 'RES'	: return '<span class="label label-info">Responded</span>'; break;

    case 'REP':
      return '<span class="label label-info">Replied</span>';
      break;

    case 'REPP':
      return '<span class="label label-info">Replied-Draft</span>';
      break;

    case 'EREP':
      return '<span class="label label-info">Esc-Replied</span>';
      break;

    case 'EREREP':
      return '<span class="label label-info">Esc-Replied,Replied</span>';
      break;

    case 'REPTRNFR':
      return '<span class="label label-info">Replied,Transfered</span>';
      break;

    case 'EREPTRNFR':
      return '<span class="label label-info">Esc-Replied,Transfered</span>';
      break;
    ...
    case 'NACP':
      return '<span class="label label-danger">Not-Accepted</span>';
      break;

    case 'INP':
      return '<span class="label label-default">Inprogress</span>';
      break;
    ...
    case 'CLOREJ':
      return '<span class="label label-danger">Close-Re-Opened</span>';
      break;

    case 'PAS':
      return '<span class="label label-info">Passed</span>';
      break;

    case 'EXST':
      return '<span class="label label-sucess">Exists</span>';
      break;

    case 'NEXST':
      return '<span class="label label-warning">Not Exists</span>';
      break;

    case 'CLOROPEN':
      return '<span class="label label-warning">Re-Opened</span>';
      break;
    // case 'COMROPEN': return '<span class="label label-warning">Admin Rejected</span>'; break;

    case 'COMROPEN':
      return '<span class="label label-warning">Admin Re-Opened</span>';
      break;
    // CR4
  }
};
  ...
  if ($.inArray(auth_user_role, complaint_raise_roles) !== -1 && data.data.user_roles && AuthUser.user_id_pk in data.data.user_roles) {
    ...
    if (data.data.user_roles[AuthUser.user_id_pk] == 'RECPT') {
      ...
      if (data.flow == 'dashboard/complaints') {
        if (data.data.status == 'CLO') {
          ...
          if ($.inArray(auth_user_role, admin_view_roles) !== -1) row += '<a data-popup="tooltip" title="Re-open" data-original-title="Re-open" href="javascript:void(0);" onclick="updateStatus(\'' + data.flow + '\',\'' + data.data.id + '\',true,\'status\',\'INP\')"><i class="fa fa-folder-open fa-lg"></i></a>&nbsp;&nbsp;';
          ...
          row += '<a data-popup="tooltip" title="Edit" data-original-title="Edit" href="javascript:void(0);" onclick="editByFlow(\'' + data.flow + '\',\'' + data.data.id + '\',' + data.modal + ')"><i class="fa fa-pencil fa-lg"></i></a>&nbsp;&nbsp;' + '<a data-popup="tooltip" title="Forward" data-original-title="Forward" href="javascript:void(0);" onclick="updateStatus(\'' + data.flow + '\',\'' + data.data.id + '\',' + data.modal + ',\'status\',\'INP\')"><i class="fa fa-mail-forward fa-lg"></i></a>&nbsp;&nbsp;' + '<a data-popup="tooltip" title="Delete" data-original-title="Delete" href="javascript:void(0);" onclick="deleteByFlow(\'' + data.flow + '\',' + data.data.id + ',\'table\')"><i class="fa fa-trash fa-lg"></i></a>';
        } else {
          row += '<a data-popup="tooltip" title="View" data-original-title="View" href="javascript:void(0);" onclick="editByFlow(\'' + data.flow + '\',\'' + data.data.id + '\',' + data.modal + ')"><i class="fa fa-eye fa-lg"></i></a>&nbsp;&nbsp;'; //			        		 '<a data-popup="tooltip" title="Reminder" data-original-title="Reminder" href="javascript:void(0);" onclick="reminderByFlow(\''+data.flow+'\',\''+data.data.id+'\','+data.modal+',\'ALL\')"><i class="fa fa-bell fa-lg"></i></a>&nbsp;&nbsp;';    	
        }
      } else if (data.flow == 'dashboard/categories') {
        if (data.data.status !== null) {
          row += '<a data-popup="tooltip" title="Edit" data-original-title="Edit" href="javascript:void(0);" onclick="editByFlow(\'' + data.flow + '\',\'' + data.data.id + '\',' + data.modal + ')"><i class="fa fa-pencil fa-lg"></i></a>&nbsp' + '<a data-popup="tooltip" title="Delete" data-original-title="Delete" href="javascript:void(0);" onclick="deleteByFlow(\'' + data.flow + '\',' + data.data.id + ',\'table\')"><i class="fa fa-trash fa-lg"></i></a>';
        }
      ...
      if (data.flow == 'dashboard/complaints') {
        ...
        if (data.data.status == 'CLO') {
          ...
          row += '<a data-popup="tooltip" title="View" data-original-title="View" href="javascript:void(0);" onclick="editByFlow(\'' + data.flow + '\',\'' + data.data.id + '\',' + data.modal + ')"><i class="fa fa-eye fa-lg"></i></a>&nbsp;&nbsp;'; //			        		 '<a data-popup="tooltip" title="Reminder" data-original-title="Reminder" href="javascript:void(0);" onclick="reminderByFlow(\''+data.flow+'\',\''+data.data.id+'\','+data.modal+',\'ESCALATED_ALL\')"><i class="fa fa-bell fa-lg"></i></a>&nbsp;&nbsp;';	   
        } else {
          ...
          if (data.data.user_status[AuthUser.user_id_pk] == 'INP') row += '<a data-popup="tooltip" title="Reject" data-original-title="Reject" href="javascript:void(0);" onclick="updateStatus(\'' + data.flow + '\',\'' + data.data.id + '\',\'true\',\'status\',\'REJ\')"><i class="fa fa-ban fa-lg"></i></a>&nbsp;&nbsp;';
        }
      ...
      if (data.flow == 'dashboard/complaints') {
        ...
        if (data.data.status == 'CLO') {
          ...
          row += '<a data-popup="tooltip" title="Reply" data-original-title="Reply" href="javascript:void(0);" onclick="editByFlow(\'' + data.flow + '\',\'' + data.data.id + '\',' + data.modal + ')"><i class="fa fa-reply fa-lg"></i></a>&nbsp;&nbsp;';
          if (data.data.user_status[AuthUser.user_id_pk] == 'INP') row += '<a data-popup="tooltip" title="Reject" data-original-title="Reject" href="javascript:void(0);" onclick="updateStatus(\'dashboard/complaints/escalations\',\'' + data.data.id + '\',true,\'status\',\'REJ\')"><i class="fa fa-ban fa-lg"></i></a>&nbsp;&nbsp;';
        }

        return row;
      }
    }
  } else if ($.inArray(auth_user_role, admin_view_roles) !== -1 || $.inArray(auth_user_role, zonal_admin_roles) !== -1 || $.inArray(auth_user_role, regional_admin_roles) !== -1 || $.inArray(auth_user_role, branch_admin_roles) !== -1) {
    //admin_view_roles
    var row = '';
    ...
    if (data.flow == 'dashboard/complaints') {
      ...
      if (data.data.status !== 'ACT') {
        row += '<a data-popup="tooltip" title="Edit" data-original-title="Edit" href="javascript:void(0);" onclick="editByFlow(\'' + data.flow + '\',\'' + data.data.id + '\',' + data.modal + ')"><i class="fa fa-pencil fa-lg"></i></a>&nbsp' + '<a data-popup="tooltip" title="Mark as Active" data-original-title="Active" href="javascript:void(0);" onclick="updateStatus(\'' + data.flow + '\',\'' + data.data.id + '\',false,\'status\',\'ACT\')"><i class="fa fa-check-square-o fa-lg"></i></a>&nbsp' + '<a data-popup="tooltip" title="Delete" data-original-title="Delete" href="javascript:void(0);" onclick="deleteByFlow(\'' + data.flow + '\',' + data.data.id + ',\'table\')"><i class="fa fa-trash fa-lg"></i></a>';
      }

      if (data.data.status == 'ACT') {
        row += '<a data-popup="tooltip" title="Edit" data-original-title="Edit" href="javascript:void(0);" onclick="editByFlow(\'' + data.flow + '\',\'' + data.data.id + '\',' + data.modal + ')"><i class="fa fa-pencil fa-lg"></i></a>&nbsp' + '<a data-popup="tooltip" title="Mark as Inactive" data-original-title="Inactive" href="javascript:void(0);" onclick="updateStatus(\'' + data.flow + '\',\'' + data.data.id + '\',false,\'status\',\'INACT\')"><i class="fa fa-remove fa-lg"></i></a>&nbsp' + '<a data-popup="tooltip" title="Delete" data-original-title="Delete" href="javascript:void(0);" onclick="deleteByFlow(\'' + data.flow + '\',' + data.data.id + ',\'table\')"><i class="fa fa-trash fa-lg"></i></a>';
      }
    } else if (data.flow == 'dashboard/sub_categories') {
      if (data.data.status !== 'ACT') {
        row += '<a data-popup="tooltip" title="Edit" data-original-title="Edit" href="javascript:void(0);" onclick="editByFlow(\'' + data.flow + '\',\'' + data.data.id + '\',' + data.modal + ')"><i class="fa fa-pencil fa-lg"></i></a>&nbsp' + '<a data-popup="tooltip" title="Mark as Active" data-original-title="Active" href="javascript:void(0);" onclick="updateStatus(\'' + data.flow + '\',\'' + data.data.id + '\',false,\'status\',\'ACT\')"><i class="fa fa-check-square-o fa-lg"></i></a>&nbsp' + '<a data-popup="tooltip" title="Delete" data-original-title="Delete" href="javascript:void(0);" onclick="deleteByFlow(\'' + data.flow + '\',' + data.data.id + ',\'table\')"><i class="fa fa-trash fa-lg"></i></a>';
...
window.displayFile = function (data) {
  if (data.source_status && data.source_url !== null) return '<span class="label border-left-primary label-striped source-label"><a href=' + (data.source_status && data.source_url !== null ? data.source_url : data.default_source_url) + ' target="_blank">' + (data.source && data.source != null ? data.source : "Source") + '</a></span>';else return '<span class="label border-left-primary label-striped source-label">Not Found</span>' + '</a></span>';
};

window.displayColor = function (data) {
  if (data.color !== null) return '<span data-popup="tooltip" title="' + data.color + '" data-original-title="View" class="badge" style="background-color:' + data.color + ';">&nbsp;</span>';else return '';
};

window.refreshTable = function (flow) {
  if ($.fn.DataTable.isDataTable(getTableByFlow(flow))) {
    console.log('Refreshing Table: >>' + flow);
    var manageTable = $(getTableByFlow(flow)).DataTable(); //		manageTable.search('').columns().search('').order( [[ 0, 'asc' ]] ).draw(false);
...
window.displayComplaintUsers = function (users) {
  ...
  if (table.find("tr").length > 1) return table[0].outerHTML;else return 'No users found';
};
...
function displaySetupModalInManage(data) {
  ...
  if (data.reloadType) $(modal + ' #refresh_type').val(data.reloadType);else $(modal + ' #refresh_type').val('table');
...
function getModalByFlow(flow) {
  switch (flow) {
    case 'dashboard/complaints':
      return '#modal_complaint_action_form';

    case 'dashboard/complaints/escalations':
      return '#modal_complaint_action_form';

    case 'dashboard/complaints/solutions/amendment':
      return '#modal_solution_amendment_form';

    case 'dashboard/modes':
      return '#modal_mode_form';

    case 'dashboard/categories':
      return '#modal_category_form';

    case 'dashboard/sub_categories':
      return '#modal_sub_category_form';
    //	case 'dashboard/zones'							: return '#modal_zone_form';
    //	case 'dashboard/regions'						: return '#modal_region_form';

    case 'dashboard/complaints/reporting':
      return '#modal_reporting_complaint_action_form';
...
function getTableByFlow(flow) {
  switch (flow) {
    ...
    case 'dashboard/sub_categories':
      return '.sub-categories-table';

    case 'dashboard/zones':
      return '.zones-table';

    case 'dashboard/regions':
    ...
    case 'dashboard/month/resol':
      return '.m-complaint-time-resolution-table';

    case 'dashboard/annual/resol':
      return '.a-complaint-time-resolution-table';

    case 'dashboard/branches':
      return '.branch-department-table';

    case '/dashboard/zones/sync_region':
      return '.regions-table';

    case '/dashboard/regions/sync_branch':
      return '.branch-department-table';
...
window.getStatusUpdateMessage = function (status, alertModule) {
  switch (status) {
    case 'PEN':
      return 'Updating will remove all the related items. Continue?';

    case 'CLO':
      return 'Complaint/Compliment will Closed. Continue? ';

    case 'INP':
      return 'Complaint/Compliment will forwarded to Complaint Owner(s). Continue? ';

    case 'ACT':
      return alertModule + ' will Activated. Continue?';

    case 'INACT':
      return alertModule + ' will Inactive. Continue?';

    case 'REJ':
      return 'Complaint/Compliment will rejected and reopened. Continue? ';

    case 'VFD':
      return 'Solution will mark as Verified. Continue? ';

    case 'ACP':
      return 'Solution will mark as Accpeted. Continue? ';

    case 'NACP':
      return 'Solution will mark as Not Accepted. Continue? ';
  }
};
...
/***/ 6:
/*!****************************************************!*\
  !*** multi ./public/dashboard/js/common/manage.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\wamp64\www\sits\complaintms_NSC_V1\public\dashboard\js\common\manage.js */"./public/dashboard/js/common/manage.js");
